...
toggle.addEventListener("click",()=>{
  ...
  d.textContent=toggle.checked?"Desarrollador Front-End Jr":"Front-End Developer Jr",
  e.textContent=toggle.checked?"Descargar Curriculum":"Download Resume",
  f.textContent=toggle.checked?"Contactame!":"Let's Talk!",
  g.textContent=toggle.checked?"Habilidades":"Skills",
  h.textContent=toggle.checked?"Resolución de problemas":"Problem Solving",
